...
export const CATEGORIES = [
  { id: 1, nombre: 'Innovation & Design', abrev: 'Innovation' },
  { id: 2, nombre: 'Development & Technical Platform', abrev: 'Development' },
  { id: 3, nombre: 'Change Leadership', abrev: 'Leadership' },
  { id: 4, nombre: 'Business & Strategy', abrev: 'Business' },
  { id: 5, nombre: 'Delivery & Portfolio', abrev: 'Delivery' },
  { id: 6, nombre: 'Emerging Technologies', abrev: 'Emerging' },
...
export const SKILLS = [
  ...
  { id: 8, categoriaId: 2, nombre: 'Systems Architecture' },
  { id: 9, categoriaId: 2, nombre: 'Backend Development' },
  { id: 10, categoriaId: 2, nombre: 'Frontend Development' },
  { id: 11, categoriaId: 2, nombre: 'API Integration' },
  { id: 12, categoriaId: 2, nombre: 'Low-code/No-code' },
  { id: 13, categoriaId: 2, nombre: 'Cybersecurity' },
  ...
  { id: 37, categoriaId: 2, nombre: 'Observability & SRE' },
